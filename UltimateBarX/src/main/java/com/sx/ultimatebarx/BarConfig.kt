...
data class BarConfig(
    ...
    companion object {
        fun newInstance(): BarConfig = BarConfig().apply {
            color = Int.MIN_VALUE
            colorRes = -1
            drawableRes = -1
            fitWindow = true
    ...
    fun fitWindow(fitWindow: Boolean): BarConfig = apply {
        this.fitWindow = fitWindow
    }

    fun color(@ColorInt color: Int): BarConfig = apply {
        drawableRes = -1
        colorRes = -1
        this.color = color
    }

    fun colorRes(@ColorRes colorRes: Int): BarConfig = apply {
        drawableRes = -1
        color = Int.MIN_VALUE
    ...
    fun light(light: Boolean): BarConfig =
            apply {
                this.light = light
            }

    fun transparent(): BarConfig = apply {
        fitWindow = false
