...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn1).setOnClickListener(view -> startActivity(new Intent(HomeActivity.this, ReadSourceActivity.class)));

        findViewById(R.id.btn2).setOnClickListener(view -> startActivity(new Intent(HomeActivity.this, RVActivity.class)));
