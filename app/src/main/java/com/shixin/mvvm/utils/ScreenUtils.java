...
public final class ScreenUtils {
    ...
    public static boolean isLandscape() {
        return BaseApp.Companion.getInstance().getResources().getConfiguration().orientation
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) BaseApp.Companion.getInstance().getSystemService(Context.KEYGUARD_SERVICE);
